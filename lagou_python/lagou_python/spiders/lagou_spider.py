...
class LagouSpider(CrawlSpider):
    ...
    def parse(self, response):
        ...
        for site in sites:
            ...
            yield item
        next_urls = []
        for k in range(2, total_page + 1):
            base_url = "http://www.lagou.com/jobs/list_Python?kd=Python&spc=1&pl=&gj=&xl=&yx=&gx=&st=&labelWords=&lc=&workAddress=&city=%E4%B8%8A%E6%B5%B7&requestId=&pn=" + str(
                k)

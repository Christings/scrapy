...
class ComtradeCatalogPipeline(object):
    def process_item(self, item, spider):
        if isinstance(item, ComtradeCatalogItem):
            ...
            newsql = "insert into Rev4_catalog_level1(catalog_level1_num,catalog_level1_name,catalog_level1_desc)values('%s','%s','%s')" % (
            ...
            ms = MySql(host="localhost", user="root", pwd="421498", db="caas")
            newsql = "insert into Rev4_catalog_level2(catalog_level2_num,catalog_level2_name,catalog_level2_desc)values('%s','%s','%s')" % (
            ...
            ms = MySql(host="localhost", user="root", pwd="421498", db="caas")
            newsql = "insert into Rev4_catalog_level3(catalog_level3_num,catalog_level3_name,catalog_level3_desc)values('%s','%s','%s')" % (
